...
//Pour cela Fetch va nous renvoyer une Promise. : la Promise est un objet qui fournit une fonction then qui sera exécutée quand le résultat aura été obtenu,
    ...
    .then(function(données) { // en ayant vérifié au préalable que la requête s’était bien passée avec res.ok. Ce résultat json étant lui aussi une Promise, nous le retournons et récupérons sa vraie valeur dans la fonction then() suivante.
